...
3. `desktop/`: shell Tauri e integração com sidecar
...
- `desktop/src-tauri/src/lib.rs`: bootstrap do app Tauri, sidecar, restart e eventos
- `desktop/src-tauri/tauri.conf.json`: configuração do app
