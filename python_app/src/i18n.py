...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "piper_models_title": "\n🎭 Piper models:",
        "piper_models_hint": "Place .onnx model files in 'python_app/models' (or a local './models')",
        ...
        "formatting_cues_title": "\n🔤 Formatting cues:",
        "formatting_cues_enable": 'Speak cues such as "quote"/"end quote", bold, italic',
        "formatting_cues_disable": "Do not narrate formatting cues",
        "select_formatting_cues_prompt": "Select option (1-2): ",
        "summary_title": "\n📝 Summary:",
        ...
        "footnote_inline_context": "   ↳ Context words: {value}",
        "footnote_chapter_end_context": "   ↳ Context window: {value} words",
        ...
        "requirements_not_found": "⚠️ requirements.txt not found. Install dependencies manually (pip install -r python_app/requirements.txt).",
        "installing_requirements": "\n📦 Installing dependencies from python_app/requirements.txt...",
        "requirements_success": "✅ Dependencies installed. Resuming conversion...\n",
        "requirements_failure": "❌ Failed to install dependencies. Run: pip install -r python_app/requirements.txt",
    ...
    "pt": {
        ...
        "piper_models_title": "\n🎭 Modelos Piper:",
        "piper_models_hint": "Coloque arquivos .onnx em 'python_app/models' (ou em './models')",
        ...
        "formatting_cues_title": "\n🔤 Narração de formatação:",
        "formatting_cues_enable": 'Falar "entre aspas", "fim das aspas", negrito, itálico',
        "formatting_cues_disable": "Não narrar marcações de formatação",
        "select_formatting_cues_prompt": "Selecione (1-2): ",
        "summary_title": "\n📝 Resumo:",
        ...
        "footnote_inline_context": "   ↳ Palavras de contexto: {value}",
        "footnote_chapter_end_context": "   ↳ Trecho de contexto: {value} palavras",
        ...
        "requirements_not_found": "⚠️ requirements.txt não encontrado. Instale manualmente (pip install -r python_app/requirements.txt).",
        "installing_requirements": "\n📦 Instalando dependências de python_app/requirements.txt...",
        "requirements_success": "✅ Dependências instaladas. Retomando conversão...\n",
        "requirements_failure": "❌ Falha ao instalar dependências. Execute: pip install -r python_app/requirements.txt",
