...
from main import ConverterApplication, ChapterStructureItem
...
class TestLanguageDetection(unittest.TestCase):
    ...
    def test_prepare_language_profile_spreads_sampling(self) -> None:
        ...
        fake_profile = LanguageProfile(primary='en', languages=['en'], predictions=[], analysed_chars=0)
    ...
    def test_rebalance_language_profile_prefers_english_when_ascii_high(self) -> None:
        ...
        adjusted = self.app._rebalance_language_profile(profile, ascii_ratio=0.85, language_votes={})
    ...
    def test_language_votes_override_profile(self) -> None:
        ...
        adjusted = self.app._rebalance_language_profile(profile, ascii_ratio=0.2, language_votes=votes)
        self.assertEqual(adjusted.primary, 'en')
        self.assertEqual(adjusted.languages[0], 'en')
