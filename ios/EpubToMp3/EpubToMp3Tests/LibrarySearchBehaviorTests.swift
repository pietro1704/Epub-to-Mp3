...
final class LibrarySearchBehaviorTests: XCTestCase {
    ...
    func testLibrarySearchUsesSharedGridInsetAndAccessibilityContract() throws {
        let root = URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
        let librarySource = try String(contentsOf: root.appendingPathComponent("EpubToMp3/Views/LibraryView.swift"))
        let searchSource = try String(contentsOf: root.appendingPathComponent("EpubToMp3/Views/LibrarySearchBar.swift"))
