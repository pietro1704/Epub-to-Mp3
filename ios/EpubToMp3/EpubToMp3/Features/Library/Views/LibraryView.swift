...
struct LibraryView: View {
    ...
    /// Pure, unit-tested ordering/filtering model shared by the SwiftUI grid
    /// and the UIKit collection view. See
    /// docs/plans/uikit-performance-migration.md.
    private var gridModel: LibraryGridModel {
        let modelSort: LibraryGridModel.SortMode
        switch sortMode {
        case .lastOpened: modelSort = .lastOpened
        case .title:      modelSort = .title
        case .addedDate:  modelSort = .addedDate
        }
